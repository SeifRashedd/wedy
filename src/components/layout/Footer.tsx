    ...
    <footer className="bg-wedding-brown text-ivory/90 mt-auto">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="text-ivory/60 text-sm leading-relaxed max-w-sm">
              Premium digital wedding invitations crafted with love. Share your special day
              beautifully with family and friends.
            </p>
          </div>

          <div>
            <h4 className="font-serif text-lg mb-4 text-champagne">Navigation</h4>
          ...
          <div>
            <h4 className="font-serif text-lg mb-4 text-champagne">Contact</h4>
            <ul className="space-y-2 text-sm text-ivory/60">
        ...
        <div className="border-t border-ivory/10 mt-12 pt-8 text-center text-sm text-ivory/40">
          © {new Date().getFullYear()} Wedy. All rights reserved.
        </div>
      </div>
    </footer>
  );
