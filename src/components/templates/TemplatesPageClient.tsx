    ...
    <div className="py-16 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-wedding-muted max-w-lg mx-auto">{t("templates.pageSub")}</p>
        </div>
          ...
          {templates.map(({ config }) => {
            ...
            return (
              <Card key={config.id} hover className="overflow-hidden">
                ...
                <div className="p-6">
                  <h2 className="font-serif text-xl text-wedding-brown">{t(nameKey)}</h2>
                  <p className="text-wedding-muted text-sm mt-2 mb-3">{t(descKey)}</p>
